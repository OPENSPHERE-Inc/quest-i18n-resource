...
export const Instruction = ({params}: {params: Parameters}) => {
    ...
    return <div className="content">
        ...
        <p>
            *  Приведенные ниже браузеры проверены с нашей стороны:
        </p>
        ...
        <p>
            Чтобы управлять аккаунтом или получать XYM с помощью сайта QUEST, вам необходимо установить кошелек
        ...
        <p>
            Регистрация на сайте будет выполнена за несколько этапов, за счет создания нового аккаунта на нашем сайте.<br />
        ...
        <blockquote>
            Вы можете внести максимум {  params.deposit_amount_max } XYM за буст, но когда вы активируете Limit Break, максимальная сумма увеличивается до x20. <br />
            Также исполнитель может установить максимальную сумму, которую можно получить.<br />
        ...
        <p>
            Возврат XYM может быть осуществлен в следующих случаях: задание было прервано, истекло,
