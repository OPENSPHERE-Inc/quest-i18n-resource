...
export const InstructionJa = ({params}: {params: Parameters}) => {
    ...
    return <div className="content">
        ...
        <blockquote>
            最終判断は、投票終了後24時間以内に行う必要があります。
            期限までに最終判断がなかった場合は「返金を受ける」を選んだものとみなされます。
        </blockquote>

        <h2 className="title is-4 mt-6">7. 実行者向け：クエスト金庫の中身を頂く</h2>
        <p>
        ...
        <p>
            ...
            返金はたとえクエストの期限前に決定されたとしても、必ず期限から48時間後以降（ブースト戦略がタイプCの場合は72時間後以降）に起こります。
            これはQUESTが使用しているブロックチェーンの仕様で、早めることが出来ません。
        </p>
    </div>;
}
